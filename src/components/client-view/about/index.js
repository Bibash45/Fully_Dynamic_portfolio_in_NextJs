...
export default function ClientAboutView({ data }) {
  ...
  return (
    <div
      className="max-w-screen-xl mt-24 mb-6 sm:mt-14 sm:mb-1 px-6 sm:px-8 lg:px-16 mx-auto "
      id="about"
    >
...
{headingText.split(" ").map((item,index)=>(
  <span className={`${index === 5 ? "text-green-main" : "text-black"}`} key={index}>{item}{" "}</span>
))}
    </h1>
